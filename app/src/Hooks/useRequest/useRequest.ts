...
type ActionRequestReducer<State> = ActionRequestReducerLoading | ActionRequestReducerSuccess<State> | ActionRequestReducerFail;
...
export const useRequest = <PromiseResponse>(
	...
	const [state, dispatch] = useReducer<ReducerRequest<PromiseResponse>>(reducerRequest, initialState);
